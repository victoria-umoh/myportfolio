                            ...
                            <div className="row py-3">
                                <div className="col-md-6">
                                    <div className="px-lg-3">
                                        ...
                                        <div className="progress">
                                            <div className="progress-bar" role="progressbar" style={{width: '79%'}} aria-valuenow={79} aria-valuemin={0} aria-valuemax={100}>79%</div>
                                        </div>
                                        </div>
                                        <div className="progress-wrapper wow fadeInUp">
                                ...
                                <div className="col-md-6">
                                    <div className="px-lg-3">
                                        ...
                                        <div className="progress-wrapper wow fadeInUp">
                                            ...
                                            <div className="progress">
                                                <div className="progress-bar bg-custom" role="progressbar" style={{ width: '90%' }} aria-valuenow={90} aria-valuemin={0} aria-valuemax={100}>90%</div>
                                            </div>
                                        </div>
                                        <div className="progress-wrapper wow fadeInUp">
                                            <span className="caption">LARAVEL</span>
                                            <div className="progress">
                                                <div className="progress-bar bg-custom" role="progressbar" style={{ width: '80%' }} aria-valuenow={80} aria-valuemin={0} aria-valuemax={100}>80%</div>
                                            </div>
                                        </div>
                                        <div className="progress-wrapper wow fadeInUp">
                                            <span className="caption">MYSQL</span>
                                            <div className="progress">
                                                <div className="progress-bar bg-custom" role="progressbar" style={{ width: '79%' }} aria-valuenow={79} aria-valuemin={0} aria-valuemax={100}>79%</div>
                                            </div>
                                        </div>
                                        <div className="progress-wrapper wow fadeInUp">
                                            <span className="caption">RESTful API</span>
                                            <div className="progress">
                                                <div className="progress-bar bg-custom" role="progressbar" style={{ width: '85%' }} aria-valuenow={85} aria-valuemin={0} aria-valuemax={100}>85%</div>
                                            </div>
                                        </div>
                                        <div className="progress-wrapper wow fadeInUp">
